const translations = {
    uk: {
        ...
        "game_started_server": "Гра розпочалась! Перший хід за {player}",
        ...
        "guess_count_prompt_server": "Гравець {player} має вгадати кількість карт {card_rank}.",
    ...
    en: {
        ...
        "game_started_server": "Game started! First turn goes to {player}",
        ...
        "guess_count_prompt_server": "Player {player} must guess the number of {card_rank} cards.",
    ...
    ru: {
        ...
        "game_started_server": "Игра началась! Первый ход за {player}",
        ...
        "guess_count_prompt_server": "Игрок {player} должен угадать количество карт {card_rank}.",
    ...
    de: {
        ...
        "game_started_server": "Spiel gestartet! Erster Zug geht an {player}",
        ...
        "guess_count_prompt_server": "Spieler {player} muss die Anzahl der {card_rank} Karten erraten.",
    ...
    es: {
        ...
        "game_started_server": "¡Juego comenzado! Primer turno para {player}",
        ...
        "guess_count_prompt_server": "El jugador {player} debe adivinar el número de cartas {card_rank}.",
